  ...
  return (
    ...
    >
      <div className="container-fluid mx-xxl-3 mx-xl-4">
        <NavLink
          className="navbar-brand w-sm-10 w-15 w-md-50 w-lg-15 w-xxl-15 w-xl-15"
          to="/"
        >
        ...
        <div
          className="collapse navbar-collapse mr-auto justify-content-center justify-content-lg-end"
